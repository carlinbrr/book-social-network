...
public class BookQueryAdapter implements BookQueryPort {
    ...
    @Override
    public Optional<BookDetailsData> findDetailsById(BookId id) {
        return jpaBookQueryRepository.findDetailsById(id.getValue()).map(BookQueryMapper::toBookDetailsData);
    }
