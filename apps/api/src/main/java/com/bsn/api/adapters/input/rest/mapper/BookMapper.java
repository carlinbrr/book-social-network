...
public class BookMapper {
    ...
    public static BookResponse toBookResponse(BookDetails bookDetails) {
        return new BookResponse(bookDetails.id(), bookDetails.title(), bookDetails.authorName(), bookDetails.isbn(),
                bookDetails.synopsis(), bookDetails.ownerFullName(), bookDetails.coverImage(), bookDetails.averageRating(),
